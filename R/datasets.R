...
#' \item{beauty}{each of the lecturers' pictures was rated by six
#' undergraduate students: three women and three men. The raters were
#' told to use a 10 (highest) to 1 rating scale, to concentrate on the
#' physiognomy of the professor in the picture, to make their ratings
#' independent of age, and to keep 5 in mind as an average. The scores
...
#' as split plots. . Note that the sampling times are $t$=0, 1.14, 2.29,
#' 3.57 and 4.57 weeks (i.e. every 7 to 8 days).
#' \describe{
...
#' types (Case and Control) and two treatments (A and B). The data is stored
#' as a data frame:
#' \describe{
